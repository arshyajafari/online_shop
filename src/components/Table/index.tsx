      ...
      <table className="w-full text-sm">
        ...
        <tbody className="text-black">
          <tr className="bg-gray-200 text-center border-b hover:bg-gray-300">
            ...
            <td className="px-6 py-4">
              <div className="flex justify-center items-center space-x-3">
                ...
                <div>
                  <input
                    type="type"
                    className="w-12 bg-gray-50 text-gray-900 text-sm border border-gray-300 rounded-lg py-1 outline-none"
                    // value={item.amount}
                    disabled
                  />
                </div>
            ...
            <td className="font-semibold px-6 py-4">{/* {item.price} */}</td>
        ...
        <tfoot className="bg-gray-700 text-gray-400 text-xs uppercase">
          <tr className="text-white font-semibold">
            ...
            <td className=""></td>
            <td className=""></td>
            <td className="text-base text-center">$21,000</td>
          </tr>
        </tfoot>
      </table>
    </Container>
